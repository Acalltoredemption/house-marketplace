...
export default function CreateListing() {
    ...
    const onSubmit = async (e) => {
        ...
        if(geolocationEnabled){
            const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=AIzaSyBo1NC4ADUCJAKyN5Y1ac5OmMJEVQCPLXM`)
        ...
        <main>
            ...
            <div>
                ...
                <div>
                    ...
                    <textarea className="formInputAddress" id="address" type="text" value={address} onChange={onMutate} required />
